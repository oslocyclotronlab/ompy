...
def rebin_and_shift(array, E_range, N_final, rebin_axis=0):
    ...
    if E_range[0] < 0 or E_range[1] < E_range[0]:
        print "Error in function rebin_and_shift(): Negative zero energy is not supported. (But it should be relatively easy to implement.)"
        sys.exit(0)
