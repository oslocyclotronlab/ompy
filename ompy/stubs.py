...
ArrayFloat: TypeAlias = Array[np.float64]
ArrayBool: TypeAlias = Array[np.bool]
ArrayInt: TypeAlias = Array[np.int64]
...
array1D: TypeAlias = np.ndarray # NDArray[Shape["*"], Floating]
array2D: TypeAlias = np.ndarray # NDArray[Shape["*, *"], Floating]
array3D: TypeAlias = np.ndarray # NDArray[Shape["*, *, *"], Floating]
