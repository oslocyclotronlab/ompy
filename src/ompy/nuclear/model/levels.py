...
from ...external.ripl3 import get_RIPL3_levels
...
class DiscreteLevels:
    ...
    @classmethod
    def from_element(cls, element: str | Nuclide, source: str = "ripl3") -> DiscreteLevels:
        match element:
            case str():
                element = Nuclide.from_str(element)
...
class LevelDensityModel:
    ...
    @classmethod
    def from_element(cls, element: Nuclide | str,
